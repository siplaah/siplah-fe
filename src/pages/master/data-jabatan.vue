    ...
    <div class="row align-items-start mb-3">
      <div class="col-md-4 d-flex justify-content-start align-items-center">
        <div class="input-group">
          ...
          <input type="text" class="form-control" v-model="searchQuery" placeholder="Search Jabatan..." />
        </div>
      </div>
        ...
        <table class="table table-striped table-hover">
          <thead>
            <tr>
              ...
              <th style="padding-right: 20px; width: 60%">Jabatan</th>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="formModalTitle">{{ formMode === 'edit' ? 'Edit' : 'Tambah' }} Jabatan</h5>
