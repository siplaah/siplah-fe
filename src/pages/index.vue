  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
      <div class="col-lg-6 col-lg-6 col-xl-6 order-0 mb-4">
        <div class="card">
          <h5 class="card-header">Rekapan Presensi Hari Ini</h5>
          <div class="table-responsive text-nowrap">
            <table class="table table-striped table-borderless">
              ...
              <tbody class="table-border-bottom-0">
                <tr>
                  <td>Albert Cook</td>
                  <td><span class="badge bg-label-primary me-1">08:17</span></td>
                </tr>
                <tr>
                  <td>Barry Hunter</td>
                  <td><span class="badge bg-label-primary me-1">08:15</span></td>
                </tr>
                <tr>
                  <td>Trevor Baker</td>
                  <td><span class="badge bg-label-primary me-1">08:05</span></td>
                </tr>
                <tr>
                  <td>Jerry Milton</td>
                  <td><span class="badge bg-label-primary me-1">08:00</span></td>
                </tr>
              </tbody>
            </table>
          </div>
